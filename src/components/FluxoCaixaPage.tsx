...
export const FluxoCaixaPage: React.FC = () => {
  ...
  const { dadosMensais, isLoading, error } = useFluxoCaixaData({
    ...
    <div className="space-y-4">
      ...
      <div className="bg-slate-900/40 border border-white/5 rounded-xl overflow-hidden">
        <div className="px-4 py-3 border-b border-white/5">
          <h2 className="text-sm font-bold text-white tracking-tight">Fluxo de Caixa</h2>
